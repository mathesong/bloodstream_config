...
generate_new_filename <- function() {
  ...
  random_seq <- stringi::stri_rand_strings(1, 5)
...
ui <- fluidPage(theme = shinytheme("flatly"),
  ...
  # App title ----
  titlePanel(div(HTML("<b>Create a customised <em>bloodstream</em> config file</b>"))),
      ...
      tabsetPanel(type = "tabs",
                  ...
                  tabPanel("Parent Fraction",
                           ...
                           p(glue("There are many options available for modelling the parent ",
                                  ...
                                  "Hierarchical models are best left for advanced users.  "),
                             #style = "font-size:14px;"
                             ),
                           ...
                           br(),
                           h4("Additional Hierarchical Modelling Options"),
                           ...
                           textInput(inputId = "pf_hgam_opt",
                                     ...
                                     value = ""),
                           p(div(HTML("<em>e.g. s(time) + s(time, sub, bs='fs', k=5) + s(time, ses, bs='fs', k=5)</em>")),
                             #style = "font-size:12px;"
                             ),
                           ),
                  tabPanel("Blood-to-Plasma Ratio",
                           ...
                           br(),
                           h4("Additional GAM / HGAM Modelling Options"),
                           ...
                           textInput(inputId = "bpr_k",
                                     ...
                                     value = "10"),
                           p(div(HTML("<em>This value must be reduced from its default of 10 when there are too few data points.</em>")),
                             style = "font-size:12px;"
                           ),
                           #br(),
                  ...
                  tabPanel("Arterial Input Function",
                           ...
                           textInput(inputId = "aif_inftime",
                                     ...
                                     value = ""),
                           p(div(HTML("<em>Required for FengConv: either the number of seconds if known, or the range if unknown, e.g. 25;30.</em>")),
                             style = "font-size:12px;"),
                           br(),
                           ...
                           p(glue("Depending on the number of samples, some of the ",
                                  ...
                                  "of 10")),
                           div(style="display:inline-block",textInput(inputId="aif_kb", label="k_before", value = "")),
                           div(style="display:inline-block",textInput(inputId="aif_ka_a", label="k_after (auto)", value = "")),
                           div(style="display:inline-block",textInput(inputId="aif_ka_m", label="k_after (manual)", value = ""))),
                  ...
                  tabPanel("Whole Blood",
                           ...
                           p(glue("Depending on the number of samples, some of the ",
                                  "k values may need to be reduced from their default ",
                                  "of 10")),
                           div(style="display:inline-block",textInput(inputId="wb_kb", label="k_before", value = "")),
                           div(style="display:inline-block",textInput(inputId="wb_ka_a", label="k_after (auto)", value = "")),
                           div(style="display:inline-block",textInput(inputId="wb_ka_m", label="k_after (manual)", value = ""))),
                  tabPanel("Download",
...
server <- function(input, output) {
  ...
  config_json <- reactive({
    ...
    ParentFraction <- list(
      ...
      starttime = input$pf_starttime,
      endtime  = input$pf_endtime,
    ...
    BPR <- list(
      ...
      starttime = input$bpr_starttime,
      endtime  = input$bpr_endtime,
      gam_k = input$bpr_k,
    ...
    AIF <- list(
      ...
      starttime = input$aif_starttime,
      endtime  = input$aif_endtime,
      expdecay_props = c(input$aif_expdecay_1,
    ...
    WholeBlood <- list(
      ...
      starttime = input$wb_starttime,
      endtime  = input$wb_endtime,
